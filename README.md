...
cp .env.example .env     # 填 ADMIN_PASSWORD、SECRET_KEY、PUBLIC_BASE_URL
...
**後台（Bearer token）**：`POST /api/admin/login`、`/import`、`/messages`、`/draft`、`/draft-from-text`(貼上文字直接產草稿)、`/articles`(建立/更新)、`/articles/{id}/publish`、`/unpublish`、`DELETE`。
